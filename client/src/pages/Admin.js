...
const columns = [
  ...
  //           api.deleteExam({EXAM_ID: props.cell.row.original['exam_Id'], PATIENT_ID: props.cell.row.original['patient_Id']});
...
// const deleteExam = (PatientID, ExamID) => {
//   let exams = this.state.exams([]);
//   // console.log(exams); 
//   exams.splice(exams.index, 1);
//   this.setState({exams})
//   // const newPatient = [...props.cells.row]; 
//   // console.log(PatientID);
//   // console.log("NEW");
//   // console.log(ExamID);
//   // const index = props.cells.row.findIndex((props.cells.row) => props.cells.row.values["PatientId"] === PatientId); 
//   // console.log(newPatient.splice(index, 1));
